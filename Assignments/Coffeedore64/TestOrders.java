...
public class TestOrders {
    public static void main(String[] args) {
        ...
        // Item item2 = new Item("latte",8,1);
        // Item item3 = new Item("drip coffee",12,2);
        // Item item4 = new Item("capuccino",15,3);
        ...
        CoffeeKiosk neworder = new CoffeeKiosk();
        neworder.addMenuItem("mocha",10);
        neworder.addMenuItem("latte",8);
        neworder.addMenuItem("drip coffee",12);
        neworder.addMenuItem("capuccino",15);
        neworder.newOrder();
        // // order4.name="Sam";
